...
class MonitorDeployments(BackgroundService):
    ...
    def _auto_extend_pool(self, pool_id, identity_name, deployment_name, user):
        ...
        try:
            ...
            message = f"Dear {user},\n\nYour pool with ID {pool_id} for deployment {deployment_name} has been extended successfully."
            self._send_email(identity_name, subject, message)
