<template>
  ...
  >
    <template #default>
        <strong> Please fund your wallet for the extension of the pools to extend your nodes expiration with an amount of {{wallet.amount}} {{wallet.balance.asset}}</strong>
