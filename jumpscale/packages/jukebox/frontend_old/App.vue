    ...
    <v-app-bar app>
      ...
      <v-menu v-model="menu" :close-on-content-click="false" offset-x>
        <template v-slot:activator="{ on }">
          ...
          <v-btn v-else text href="/auth/login?next_url=/jukebox/">
...
module.exports = {
  data() {
    return {
      ...
      dialogLinear: true,
      dialogColor: "primary",
      dialogMessage: "Updating the jukebox deployer...",
    };
  },
  methods: {
    getCurrentUser() {
    ...
    async serverIsrunningCheck() {
      ...
      this.dialogMessage = "Error in updating jukebox deployer, please contact support.";
    },
